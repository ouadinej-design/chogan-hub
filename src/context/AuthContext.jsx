...
export const ROLES = {
  admin: {
    ...
    apps: ['commandes','orders','inspirations','clients','fidelite','agenda','planner','wallet','reseau','catalogue','coach','objections','stats','settings','formation','prospection','prospection-nada','familles','catalogues','checklist'],
  },
  marraine: {
