  ...
  return (
    <div style={{ padding: '20px', background: '#FAF7F2', minHeight: '100vh', fontFamily: 'sans-serif' }}>
      ...
      <div style={{ display: 'flex', gap: '10px', marginBottom: '20px' }}>
        <button onClick={() => setActiveTab('arbre')} style={{ padding: '8px 16px', borderRadius: '20px', background: activeTab === 'arbre' ? '#D2B795' : 'white', border: '1px solid #D2B795' }}>Arbre</button>
        <button onClick={() => setActiveTab('tableau')} style={{ padding: '8px 16px', borderRadius: '20px', background: activeTab === 'tableau' ? '#D2B795' : 'white', border: '1px solid #D2B795' }}>Gestion</button>
      </div>
      ...
      {selectedMember && (
        <div style={{ position: 'fixed', top:0, left:0, width:'100%', height:'100%', background: 'rgba(0,0,0,0.5)', display:'flex', alignItems:'center', justifyContent:'center', zIndex: 1000 }}>
          <div style={{ background: 'white', padding: '20px', borderRadius: '16px', width: '320px' }}>
            ...
            <button onClick={() => setSelectedMember(null)} style={{ padding: '8px', width: '100%' }}>Fermer</button>
          </div>
        </div>
      )}
    </div>
